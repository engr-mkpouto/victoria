class Webcam{
    constructor(e,t="environment",s=null,i=null){
        this._webcamElement=e,
        this._webcamElement.width=this._webcamElement.width||50,
        this._webcamElement.height=this._webcamElement.height||70,
        this._facingMode=t,
        this._webcamList=[],this._streamList=[],
    ...
    getVideoInputs(e){
        ...
        1==this._webcamList.length&&(this._facingMode="environment"),
        this._webcamList
    }
    ...
    selectCamera(){
        ...
        if("user"==this._facingMode&&e.label.toLowerCase().includes("front")
        ||"enviroment"==this._facingMode&&e.label.toLowerCase().includes("back")){
            this._selectedDeviceId=e.deviceId;break
        }
    }
    ...
    snap(){
        if(null!=this._canvasElement){
            ...
            return"user"==this._facingMode&&(e.translate(this._canvasElement.width,0),e.scale(-1,1)),
